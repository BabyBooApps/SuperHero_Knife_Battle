...
public class RewardedAdController : MonoBehaviour
{
  ...
  private const string _adUnitId = "ca-app-pub-6727597482466175/7595958991";
#elif UNITY_IPHONE
    ...
    public void ShowAd()
    {
        if (_rewardedAd != null && _rewardedAd.CanShowAd())
        {
            ...
            _rewardedAd.Show((Reward reward) =>
            {
                    ...
                    MainScript.Instance.AddRewards();
            });
        ...
        else
        {
            ...
            AdsManager.Instance.On_Admob_Reward_Video_Failed_To_Show();
